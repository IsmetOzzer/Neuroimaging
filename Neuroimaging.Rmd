...
![Her bir DICOM dosyası beyinde bir slayt olacak şekilde kaydelidir](Neuroimaging_insertimage_1.png){width=50%}
...
![Transposing](Neuroimaging_insertimage_2.png){width=50%}
...
![yukarıdaki 5x5 matrixin görseldeki karşılığı](Neuroimaging_insertimage_3.png){width=50%}
